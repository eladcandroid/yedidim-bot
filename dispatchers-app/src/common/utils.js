...
export const getInstance = () => {
  ...
  // Old development environment was call sandbox2
  if (channel === 'sandbox2') {
    return 'development'
  }

  return !/(sandbox2|development|production)/.test(channel)
    ? 'production'
    : channel
}
...
export const getGoogleMapsUrl = event => {
  return (
    ...
    event.details.geo.lat +
    ',' +
    event.details.geo.lon
  )
}
