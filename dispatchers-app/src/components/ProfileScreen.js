    ...
    return (
      <View style={styles.container}>
        ...
        >
          ...
          <Switch
            value={this.props.user.notifications}
            onValueChange={this.props.enableNotifications.bind(this)}
          />
        </View>
        <View
          style={[
        ...
        {this.props.instance !== InstanceTypes.Production ? (
          ...
          >
            ...
            <Text style={getTextStyle(styles.field)}>
              {this.props.instance}
            </Text>
          </View>
        ) : (
        ...
        <View style={styles.buttonRow}>
          <Button
            onPress={this.props.sendTestNotification.bind(this)}
            title="בדוק התראות"
          />
        </View>
        <View style={styles.buttonRow}>
