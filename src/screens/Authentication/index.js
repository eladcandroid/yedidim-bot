          ...
          <Content padder>
            {authError ? (
              <View>
                <FormattedMessage
                  ...
                  defaultMessage="An error has occurred, unable to authenticate. Please try
              again later."
                >
                  {txt => <IntroText>{txt}</IntroText>}
                </FormattedMessage>
              ...
              <FormattedMessage
                ...
                defaultMessage="You are not authenticated yet. Please authenticate to receive
              events."
              >
                {txt => <IntroText>{txt}</IntroText>}
              </FormattedMessage>
            ...
            <ButtonsView>
              <StyledButton success onPress={this.handleAuthentication}>
                <FormattedMessage
                  id="Authentication.button.authenticate"
